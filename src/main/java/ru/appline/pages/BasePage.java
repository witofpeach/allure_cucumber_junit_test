...
public class BasePage {
    ...
    public void selectAndClick(WebElement menuToClick) {
        wait.until(ExpectedConditions.visibilityOf(menuToClick));
        action.moveToElement(menuToClick).click(menuToClick).build().perform();
    }
}
